...
class OgloszenieResourceIT {
    ...
    private static final Instant DEFAULT_DATA_PUBLIKACJI = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATA_PUBLIKACJI = Instant.now().truncatedTo(ChronoUnit.MILLIS);

    private static final Instant DEFAULT_DATA_WAZNOSCI = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATA_WAZNOSCI = Instant.now().truncatedTo(ChronoUnit.MILLIS);

    private static final Instant DEFAULT_START_OD = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_START_OD = Instant.now().truncatedTo(ChronoUnit.MILLIS);
