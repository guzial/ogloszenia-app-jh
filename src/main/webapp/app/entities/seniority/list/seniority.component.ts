...
import { SeniorityDeleteDialogComponent } from '../delete/seniority-delete-dialog.component';
...
export class SeniorityComponent implements OnInit {
  ...
  delete(seniority: ISeniority): void {
    const modalRef = this.modalService.open(SeniorityDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.seniority = seniority;
